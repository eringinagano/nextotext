...
Route::get('/message/{message}/detail', 'MessageController@showMessageDetail')->name('message.detail');
Route::post('/message/{message}/detail', 'MessageController@postMessage')->name('message.post');
